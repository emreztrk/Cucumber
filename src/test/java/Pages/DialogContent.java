...
public class DialogContent extends Parent {
    ...
    @FindBy(xpath = "//ms-text-field[@formcontrolname='name']/input") // her sayfada geçerli olan ortak locator
    ...
    public WebElement deleteImgageBtn;
    ...
    public WebElement getWebElement(String strButton){
        ...
        switch (strButton){
            ...
            case "academicPeriod2": return academicPeriod2;
    ...
    public void deleteItem(String searchText){
        ...
        clickFunction(deleteImgageBtn);
        clickFunction(deleteDialogBtn);
    }



    // AŞAĞIDAKİ KODLARI BİR FONKSİYON HALİNE GETİRİP PARENT CLASSINDA TOPLADIK VE EXTEND EDEREK İNTHERİT
    // ETMİŞ OLDUK.
